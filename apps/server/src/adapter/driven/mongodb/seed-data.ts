...
export const projects: Project[] = [
  {
    id: IDS.proj1,
    name: "Acme Logistics Platform",
    description:
      "Full-stack web application for managing fleet logistics, route optimization, and real-time shipment tracking for Acme Corp's delivery network.",
    ...
    features: [
      {
        ...
        description: "Live GPS tracking of all delivery vehicles on an interactive map",
        priority: "critical",
      },
      {
        id: oid(),
        name: "Route optimization",
        description: "AI-powered route suggestions based on traffic, weather, and delivery windows",
        priority: "high",
      },
      {
        id: oid(),
        name: "Driver mobile app",
        description: "Companion mobile app for drivers to receive routes and update delivery status",
        priority: "high",
      },
      {
        id: oid(),
        name: "Analytics dashboard",
        description: "Operational metrics, delivery performance, and cost analysis dashboards",
        priority: "medium",
      },
    ],
    userRoles: ["Admin", "Dispatcher", "Driver", "Warehouse Manager"],
    integrations: ["Google Maps API", "Twilio SMS", "Stripe Billing"],
    budgetRange: { min: 100000, max: 250000, currency: "USD" },
    timeline: {
      startDate: d("2026-01-15T00:00:00Z"),
      endDate: d("2026-07-15T00:00:00Z"),
      estimatedWeeks: 26,
    },
    attachments: [],
    assignedTeam: [IDS.pm1, IDS.dev1, IDS.dev2, IDS.qa1],
    specificationId: IDS.spec1,
    progress: 35,
    milestones: [
      {
        id: oid(),
        name: "MVP Backend & Auth",
        description: "Core API, authentication, and database setup",
        dueDate: d("2026-02-28T00:00:00Z"),
        completedAt: d("2026-02-25T00:00:00Z"),
        status: "completed",
      },
      {
        id: oid(),
        name: "Fleet Tracking Module",
        description: "Real-time GPS integration and map UI",
      ...
      },
      {
        ...
        description: "AI route planning and optimization algorithms",
        dueDate: d("2026-05-30T00:00:00Z"),
        status: "pending",
      },
      {
        id: oid(),
        name: "QA & Launch",
        description: "Full regression testing and production deployment",
        dueDate: d("2026-07-15T00:00:00Z"),
        status: "pending",
      },
    ],
  ...
  {
    id: IDS.proj2,
    name: "GreenLeaf Sustainability Tracker",
    description:
      "Mobile application for tracking corporate carbon footprint, sustainability metrics, and ESG compliance reporting for GreenLeaf Technologies.",
    ...
    features: [
      {
        ...
        description: "Automated carbon emissions tracking across Scope 1, 2, and 3",
        priority: "critical",
      },
      {
        id: oid(),
        name: "ESG reporting",
        description: "Automated generation of ESG compliance reports",
        priority: "high",
      },
      {
        id: oid(),
        name: "Sustainability goals",
        description: "Goal setting and progress tracking for sustainability targets",
        priority: "medium",
      },
    ],
    userRoles: ["Admin", "Sustainability Manager", "Department Head", "Auditor"],
    integrations: ["EPA API", "Bloomberg ESG Data"],
    budgetRange: { min: 50000, max: 100000, currency: "USD" },
    timeline: {
      startDate: d("2026-04-01T00:00:00Z"),
      endDate: d("2026-09-01T00:00:00Z"),
      estimatedWeeks: 22,
    },
    attachments: [],
    assignedTeam: [IDS.pm2, IDS.dev3],
    progress: 0,
    milestones: [],
  ...
  {
    id: IDS.proj3,
    name: "Nordic SaaS AI Chatbot",
    description:
      "Conversational AI system for Nordic SaaS's customer support platform with multilingual NLP and knowledge-base integration.",
    ...
    features: [
      {
        ...
        description: "Support for English, Swedish, Norwegian, Danish, and Finnish",
        priority: "critical",
      },
      {
        id: oid(),
        name: "Knowledge base integration",
        description: "RAG pipeline connected to existing help center articles",
        priority: "high",
      },
      {
        id: oid(),
        name: "Agent handoff",
        description: "Seamless escalation to human agents with full conversation context",
        priority: "high",
      },
    ],
    userRoles: ["Admin", "Support Agent", "Customer"],
    integrations: ["Zendesk", "Slack", "OpenAI API"],
    budgetRange: { min: 75000, max: 150000, currency: "USD" },
    timeline: {
      startDate: d("2026-05-01T00:00:00Z"),
      endDate: d("2026-11-01T00:00:00Z"),
      estimatedWeeks: 26,
    },
    attachments: [],
    assignedTeam: [],
  ...
  {
    id: IDS.proj4,
    name: "Acme Inventory Management",
    description:
      "Web-based inventory and warehouse management system with barcode scanning and automated reorder workflows.",
    clientId: IDS.client1,
    status: "lead",
    type: "web_app",
    features: [
      {
        ...
        description: "Mobile-friendly barcode and QR code scanning for inventory intake",
        priority: "critical",
      },
      {
        id: oid(),
        name: "Automated reordering",
        description: "Rules-based automatic purchase order generation at low stock thresholds",
        priority: "high",
      },
    ],
    userRoles: ["Admin", "Warehouse Staff", "Procurement"],
    integrations: ["QuickBooks", "ShipStation"],
    budgetRange: { min: 25000, max: 50000, currency: "USD" },
    timeline: {
      startDate: d("2026-06-01T00:00:00Z"),
