...
export const serviceItems: ServiceItem[] = [
  { id: oid(), title: "Custom Software", description: "Full-stack development tailored to your business workflows and growth trajectory.", icon: "code", features: ["Web applications", "SaaS platforms", "Internal tools", "API development"], status: "active", projectCount: 5, color: "#6C63FF", order: 1, createdAt: d("2025-01-01T00:00:00Z"), updatedAt: d("2025-01-01T00:00:00Z") },
  { id: oid(), title: "Mobile Apps", description: "Native and cross-platform mobile experiences that delight users and drive engagement.", icon: "phone", features: ["iOS & Android", "React Native", "Push notifications", "Offline support"], status: "active", projectCount: 3, color: "#00D4AA", order: 2, createdAt: d("2025-01-01T00:00:00Z"), updatedAt: d("2025-01-01T00:00:00Z") },
  { id: oid(), title: "AI / ML", description: "Intelligent systems that learn, automate, and unlock insights from your data.", icon: "psychology", features: ["Predictive analytics", "NLP & chatbots", "Computer vision", "ML pipelines"], status: "active", projectCount: 3, color: "#8B85FF", order: 3, createdAt: d("2025-01-01T00:00:00Z"), updatedAt: d("2025-01-01T00:00:00Z") },
  { id: oid(), title: "Blockchain", description: "Smart contracts, tokenization, and decentralized platforms built for trust.", icon: "token", features: ["Smart contracts", "DeFi protocols", "NFT platforms", "Token engineering"], status: "active", projectCount: 0, color: "#33DDBB", order: 4, createdAt: d("2025-01-01T00:00:00Z"), updatedAt: d("2025-01-01T00:00:00Z") },
  { id: oid(), title: "DevOps", description: "Cloud infrastructure, CI/CD pipelines, and monitoring that keeps your stack reliable.", icon: "cloud", features: ["AWS/GCP/Azure", "Kubernetes", "CI/CD pipelines", "Monitoring"], status: "active", projectCount: 2, color: "#6C63FF", order: 5, createdAt: d("2025-01-01T00:00:00Z"), updatedAt: d("2025-01-01T00:00:00Z") },
  { id: oid(), title: "Data Engineering", description: "ETL pipelines, data warehouses, and real-time analytics infrastructure.", icon: "storage", features: ["Data pipelines", "Data warehousing", "Stream processing", "BI dashboards"], status: "coming_soon", projectCount: 0, color: "#F59E0B", order: 6, createdAt: d("2025-01-01T00:00:00Z"), updatedAt: d("2025-01-01T00:00:00Z") },
];
