...
const slides = [
  {
    ...
    description: "We're an engineering company building intelligent digital infrastructure for organizations, industries, and nations — not isolated applications.",
    color: "#6C63FF",
    accent: "#8B85FF",
  },
  {
    ...
    subtitle: "We model industries, not features",
    description: "We study how an industry actually works, standardize its language, then engineer the operating system it runs on — reusable from day one.",
    color: "#00D4AA",
    accent: "#33DDBB",
  },
  {
    ...
    subtitle: "Software is temporary. Data lives forever.",
    description: "We define open, implementation-independent standards so organizations never lose their information when they change software providers.",
    color: "#6C63FF",
    accent: "#8B85FF",
  },
  {
