...
function HeroCell({
  ...
  return (
    ...
    >
      ...
      {/* Hover glow */}
      {hovered && (
        <Box sx={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", width: "60%", height: "60%", borderRadius: "50%", background: `radial-gradient(circle, ${color}08 0%, transparent 70%)`, filter: "blur(40px)", pointerEvents: "none" }} />
      )}
      ...
      {/* Bottom accent */}
      <Box sx={{ position: "absolute", bottom: 0, left: "10%", right: "10%", height: 2, background: `linear-gradient(90deg, transparent, ${color}, transparent)`, opacity: hovered ? 0.5 : 0, transition: "opacity 0.3s", pointerEvents: "none" }} />
...
export default function PageHero({
  ...
  return (
    ...
    >
      ...
      {/* Right — icon */}
      <HeroCell color={iconColor} index="—" colInRow={1} totalCols={2} minH={{ xs: 160, md: 340 }}>
