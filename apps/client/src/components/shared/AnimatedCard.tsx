...
interface CellProps {
  ...
  animDelay?: number;
  /** Alias for animDelay — accepted for backward-compat with older call sites */
  delay?: number;
...
export default function Cell({
  ...
  // Resolve animation delay from either prop (animDelay wins)
  const resolvedDelay = animDelay ?? delay;
  ...
  return (
    <MotionBox
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 0.5, delay: resolvedDelay ?? colInRow * 0.15 }}
