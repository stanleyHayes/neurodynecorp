              ...
              <Box sx={{ flex: 1, minWidth: 0 }}>
                <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 0.5 }}>
                  ...
                  <Chip
                    ...
                    size="small"
                    sx={{ fontFamily: "monospace", fontSize: "0.6rem", bgcolor: `${color}18`, color, border: `1px solid ${color}30` }}
                  />
                </Stack>
                ...
                <Chip label={sub.projectType} size="small" variant="outlined" sx={{ fontFamily: "monospace", fontSize: "0.55rem", height: 22, mb: 1 }} />

                <Typography variant="body2" sx={{ color: "text.secondary", opacity: 0.7, lineHeight: 1.6 }}>
                  {sub.message}
                </Typography>
              </Box>
              <Typography sx={{ fontFamily: "monospace", fontSize: "0.6rem", color: "text.secondary", opacity: 0.5, flexShrink: 0, ml: 2 }}>{formatDate(sub.createdAt)}</Typography>
            </Stack>
          </Cell>
        );
      })}
