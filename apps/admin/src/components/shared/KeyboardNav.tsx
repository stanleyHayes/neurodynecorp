...
const ROUTES: Record<string, { path: string; label: string }> = {
  ...
  r: { path: "/projects", label: "Projects" },
  t: { path: "/tasks", label: "Tasks" },
  m: { path: "/team", label: "Team" },
  f: { path: "/finance", label: "Finance" },
  a: { path: "/analytics", label: "Analytics" },
  b: { path: "/blog", label: "Blog Posts" },
  o: { path: "/portfolio", label: "Portfolio" },
  l: { path: "/testimonials", label: "Testimonials" },
  v: { path: "/services", label: "Services" },
  i: { path: "/contact-submissions", label: "Contact Submissions" },
